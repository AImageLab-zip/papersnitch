    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_pdf', models.BooleanField(default=False, verbose_name='Dataset got from the PDF')),
                ('paper', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='datasets_info', to='webApp.paper')),
            ],
            options={
